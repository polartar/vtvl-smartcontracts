...
export interface VTVLMerkelVestingInterface extends utils.Interface {
  functions: {
    ...
    "revokeClaim((uint40,uint40,uint40,uint40,uint40,uint256,uint256,address))": FunctionFragment;
...
export interface VTVLMerkelVesting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: VTVLMerkelVestingInterface;
